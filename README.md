...
### Add chart(two y axis) to XLSX file
...
import (
	...
	"github.com/littletwolee/excelize"
)
...
func main() {
	...
	err := f.AddChart("Sheet1", "E1", `{"type":"line","need_2_y_axis":true,"series":[{"name":"Sheet1!$A$2","categories":"Sheet1!$B$1:$D$1","values":"Sheet1!$B$2:$D$2"},{"name":"Sheet1!$A$3","categories":"Sheet1!$B$1:$D$1","values":"Sheet1!$B$3:$D$3"},{"secondary":true,"name":"Sheet1!$A$4","categories":"Sheet1!$B$1:$D$1","values":"Sheet1!$B$4:$D$4"}],"title":{"name":"Fruit 3D Clustered Column Chart"}}`)
	if err != nil {
		fmt.Println(err)
		return
	}
